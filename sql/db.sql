...
(
    ...
    username      CHAR(36)               NOT NULL,                -- Username
...
(
    ...
    carID          CHAR(36)                                                          NOT NULL,                   -- Reference to Car
...
(
    ...
    paymentStatus ENUM ('pending', 'completed', 'failed', 'refunded', 'cancelled') NOT NULL DEFAULT 'pending', -- Payment status
    userId        CHAR(36)                                                         NOT NULL,                   -- Reference to User
    createdAt     DATETIME                                                                  DEFAULT CURRENT_TIMESTAMP,
