...
VALUES (@customer1, '2024-02-17 10:00:00', 'Airport', 'Hotel Grand', '10:30:00', '11:00:00', @vehicle1, 'confirmed',
        15.50, 2500.00, 0.00, 250.00, 1000.00, @user1),
       (@customer2, '2024-02-17 11:30:00', 'Hotel Plaza', 'Shopping Mall', '12:00:00', '12:30:00', @vehicle2,
        'completed', 8.75, 1500.00, 100.00, 150.00, 1000.00, @user2),
       (@customer3, '2024-02-17 13:00:00', 'Office Complex', 'Restaurant Row', '13:30:00', '14:00:00', @vehicle3,
        'pending', 5.25, 1000.00, 50.00, 100.00, 1000.00, @user3),
       (@customer4, '2024-02-17 14:30:00', 'University', 'Library', '15:00:00', '15:30:00', @vehicle4, 'confirmed',
        3.80, 800.00, 0.00, 80.00, 1000.00, @user4),
       (@customer5, '2024-02-17 16:00:00', 'Train Station', 'Residential Area', '16:30:00', '17:00:00', @vehicle5,
        'cancelled', 12.30, 2000.00, 200.00, 200.00, 1000.00, @user5),
       (@customer1, '2024-02-17 17:30:00', 'Shopping Mall', 'Airport', '18:00:00', '18:30:00', @vehicle1, 'completed',
        16.20, 2600.00, 100.00, 260.00, 1000.00, @user1),
       (@customer2, '2024-02-17 19:00:00', 'Restaurant', 'Hotel Plaza', '19:30:00', '20:00:00', @vehicle2, 'confirmed',
        7.50, 1300.00, 50.00, 130.00, 1000.00, @user2),
       (@customer3, '2024-02-17 20:30:00', 'Cinema', 'Office Complex', '21:00:00', '21:30:00', @vehicle3, 'pending',
        4.90, 950.00, 0.00, 95.00, 1000.00, @user3),
       (@customer4, '2024-02-17 22:00:00', 'Night Club', 'University', '22:30:00', '23:00:00', @vehicle4, 'confirmed',
        6.70, 1200.00, 100.00, 120.00, 1000.00, @user4),
       (@customer5, '2024-02-17 23:30:00', 'Hotel Grand', 'Train Station', '00:00:00', '00:30:00', @vehicle5, 'pending',
        9.40, 1700.00, 150.00, 170.00, 1000.00, @user5);
